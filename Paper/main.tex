...
\midrule
P0 & Atomic Decision Boundaries~\cite{fernandez2026a}     & 10.5281/zenodo.19670649 & arXiv:2604.17511\\
P1 & Agent Control Protocol (ACP)~\cite{fernandez2026b}   & 10.5281/zenodo.19672575 & arXiv:2603.18829\\
P2 & From Admission to Invariants (IML)~\cite{fernandez2026c} & 10.5281/zenodo.19672589 & arXiv:2604.17517\\
P3/4 & Irreducible Governance Structure~\cite{fernandez2026govstr} & 10.5281/zenodo.19672597 + 10.5281/zenodo.19672608 & TBD\\
...
the four-layer architecture of Paper~3/4~(\cite{fernandez2026govstr}).
\end{abstract}
...
own invariants.
Paper~3/4~\cite{fernandez2026govstr} addresses both distributive limits
under strategy-proof allocation mechanisms and proves the irreducibility of the
four-layer governance architecture.
This paper (P5) closes the series by addressing the runtime question: given
that observability is incomplete (P2) and the architecture is irreducible (P3/4),
...
\paragraph{Paper 3/4 (Governance Structure)~\cite{fernandez2026govstr}.}
Paper~3/4 establishes two complementary results. First, strategy-proof allocation
mechanisms face irreducible distributive limits under Sybil amplification; RAM's
conservative halting can be combined with its fair allocation framework to ensure
halts are distributed equitably across agents. Second, it proves that the
four-layer governance architecture (L0--L3) is irreducible under finite
observability. RAM operates as the execution authority layer within L2 (behavioral
control), interacting with L1 (admission/ACP) and L3 (compositional invariants),
and completes the execution semantics of the four-layer architecture.
...
P3/4 & Is governance structure irreducible? & Fair allocation + compositional irreducibility \\
