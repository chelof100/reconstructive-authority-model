...
own invariants.
Paper~3/4~\cite{fernandez2026govstr} addresses distributive limits under strategy-proof
mechanisms and proves the irreducibility of the four-layer governance architecture.
...
\paragraph{Papers 3/4 (Governance Structure)~\cite{fernandez2026govstr}.}
P3/4 shows that strategy-proof allocation mechanisms face distributive limits
under Sybil amplification, and proves that the four-layer governance architecture
(L0--L3) is irreducible. RAM's conservative halting can be combined with the
fair allocation framework to ensure that halts are distributed equitably across agents.
